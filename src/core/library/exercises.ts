...
export const EXERCISES: readonly Exercise[] = [
  ...
  mk({ id: 'band-chest-press', name: 'Band Chest Press', nameSv: 'Bröstpress med band', pattern: 'push_h', tier: 'T3', equipment: ['bands'], cue: 'Squeeze at full extension.', alternatives: ['push-up', 'db-bench-press'] }),
  ...
  mk({ id: 'band-row', name: 'Band Row', nameSv: 'Bandrodd', pattern: 'pull_h', tier: 'T3', equipment: ['bands'], cue: 'Squeeze for a beat at the back.', alternatives: ['inverted-row', 'chest-supported-db-row'] }),
  ...
  mk({ id: 'band-assisted-pull-up', name: 'Band-Assisted Pull-Up', nameSv: 'Pull-ups med band', pattern: 'pull_v', tier: 'T2', equipment: ['pullup_bar', 'bands'], repLo: 5, repHi: 12, loadable: false, cue: 'Use the least assistance that lets you finish clean.', alternatives: ['chin-up', 'lat-pulldown'] }),
  mk({ id: 'negative-pull-up', name: 'Negative Pull-Up', nameSv: 'Negativa pull-ups', pattern: 'pull_v', tier: 'T2', equipment: ['pullup_bar'], repLo: 3, repHi: 6, defaultTempo: '50X1', loadable: false, cue: 'Jump to the top, take five seconds down.', alternatives: ['band-assisted-pull-up', 'lat-pulldown'] }),
  mk({ id: 'band-lat-pulldown', name: 'Band Lat Pulldown', nameSv: 'Latsdrag med band', pattern: 'pull_v', tier: 'T3', equipment: ['bands'], cue: 'Long arms, pull from the lats not the hands.', alternatives: ['lat-pulldown', 'band-row'] }),
  ...
  mk({ id: 'band-curl', name: 'Band Curl', nameSv: 'Bandcurl', pattern: 'isolation_upper', tier: 'T3', equipment: ['bands'], cue: 'Squeeze at the top, resist on the way back.', alternatives: ['db-curl', 'hammer-curl'] }),
  ...
  mk({ id: 'band-triceps-pushdown', name: 'Band Triceps Pushdown', nameSv: 'Tricepspress med band', pattern: 'isolation_upper', tier: 'T3', equipment: ['bands'], cue: 'Lock out fully, control the return.', alternatives: ['triceps-pushdown', 'overhead-triceps-extension'] }),
